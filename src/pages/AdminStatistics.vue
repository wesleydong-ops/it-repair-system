    ...
    <aside class="fixed left-0 top-0 h-screen w-64 bg-white shadow-lg">
      ...
      <nav class="p-4">
        <ul class="space-y-2">
          ...
          <li>
            <a href="/admin/statistics" class="flex items-center gap-3 px-4 py-3 bg-primary text-white rounded-lg">
...
import { Wrench, LayoutDashboard, Users, Settings, BarChart3, LogOut, Download, Ticket, CheckCircle, Clock, ExternalLink, PieChart as PieChartIcon, MapPin } from 'lucide-vue-next'
